...
- [卡兹克：我理解的 Harness Engineering](https://x.com/khazix0918/status/2044258725536690270) — 本文核心框架与三阶段类比的灵感来源
- [OpenAI: Harness Engineering Blog](https://openai.com/) — Harness Engineering 概念的正式提出
- [Anthropic: Claude Agent SDK](https://www.anthropic.com/) — "Agent Harness" 术语的早期使用
- [Birgitta Böckeler: Guides & Sensors Framework](https://martinfowler.com/) — Harness 的前馈/反馈控制框架
